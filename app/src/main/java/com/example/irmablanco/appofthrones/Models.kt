...
data class House(
    ...
    companion object {
        ...
        private val resources = mapOf(
                ...
                Pair("targaryen", arrayOf(R.color.targaryenOverlay, R.color.targaryenOverlay, R.drawable.ic_targaryen)),
        ...
        fun getOverlayColor(houseId: String): Int {
            val palette: Array<Int>? = resources.getOrDefault(houseId, DEFAULT_PALETTE)
            return palette!![0]
        }
